...
<body>
    ...
    <div>
        <table class="table table-bordered rincian"
            ...
            <tr>
                <td colspan="4" style="text-align: center;border:1px solid black"><b>{{ $jenis_spp }}</b></td>
            </tr>
            <tr style="border:1px solid black">
                <td colspan="2" style="width: 50%">1. Nama SKPD/Unit Kerja</td>
                <td>:</td>
                <td>{{ $skpd->nm_skpd }}</td>
            </tr>
            <tr style="border:1px solid black">
            ...
            <tr style="border:1px solid black">
                <td colspan="2" style="vertical-align: top">9. Untuk Keperluan</td>
                <td style="vertical-align: top">:</td>
                <td style="vertical-align: top">{{ $data->keperluan }}</td>
            </tr>
            <tr style="border:1px solid black">
                <td colspan="2" style="vertical-align: top">10. Dasar Pengeluaran</td>
                <td style="vertical-align: top">:</td>
                <td style="vertical-align: top">SPD....Nomor: {{ $data->no_spd }} tanggal
        ...
        <table class="table table-bordered rincian"
            ...
            <tr>
                <td class="border" style="width: 40px;text-align:center">I</td>
            ...
            <tr>
                <td class="border" style="width: 40px;text-align:center">II</td>
            ...
            @if ($sub_kegiatan == '5.02.00.0.06.62')
                ...
                {{-- <tr>
                <td colspan="4" style="text-align: center;padding-left:700px">{{ $bendahara->pangkat }}
                </td>
            </tr>
            <tr>
            ...
            @else
                ...
                {{-- <tr>
                <td colspan="2" style="text-align: center;padding-left:100px">{{ $pptk->pangkat }}</td>
                <td colspan="2" style="text-align: center;padding-left:300px">{{ $bendahara->pangkat }}
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center;padding-left:100px">{{ $pptk->nip }}</td>
