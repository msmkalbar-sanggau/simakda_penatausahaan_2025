...
<script>
    $(document).ready(function() {
        ...
        $('#kode_rekening').on('change', function() {
            ...
            let tgl_bukti = document.getElementById('tgl_bukti').value;
            let bln = new Date(tgl_bukti);
            let bulan = bln.getMonth() + 1;
            $.ajax({
        ...
        $('#simpan-btn').on('click', function() {
            ...
            let total_angkas = angka(document.getElementById('total_angkas').value);
            ...
            let csp2d = 0;
            let clalu = 0;
            let nilai_total_penagihan = angka(document.getElementById('total_input_penagihan')
                .value) || 0;
            if (!kdgiat) {
        ...
        $('#simpan_penagihan').on('click', function() {
            ...
            if (!basthp) {
                alert('Silahkan isi No BA Serah Terima Hail Pekerjaan !!', "error");
                return;
            };
            if (!bap) {
        ...
        function cek_nilai_kontrak(no_bukti, no_kontrak, ket, ket_bast, total_nilai, sisa_kontrak, tgl_bukti,
            ...
            tahun_anggaran, tahun, ctagih, ctgltagih, jns_trs, cek, bap,
            basthp, bapp) {
            $.ajax({
