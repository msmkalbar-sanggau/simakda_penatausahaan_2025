...
@section('title', 'Tambah Verifikasi SPP | SIMAKDA')
@section('content')
                ...
                <div class="card-body">
                                ...
                                <optgroup label="Daftar SPP">
                                    @foreach ($data_spp as $spp)
                                        ...
                                        <option value="{{ $spp->no_spp }}" data-tgl_spp="{{ $spp->tgl_spp }}"
                                            ...
                                            data-rekening="{{ $spp->no_rek }}" {{-- data-kd_sub_skpd="{{ $spp->kd_sub_skpd }}" --}}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            ...
                            {{-- <input class="form-control @error('kd_sub_skpd') is-invalid @enderror" type="text" id="kd_sub_skpd" name="kd_sub_skpd" required hidden> --}}
                            @error('kd_skpd')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            <input class="form-control @error('bulan') is-invalid @enderror" type="text"
                                id="bulan"name="bulan" required hidden readonly>
                ...
                <div class="card-body table-responsive">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-12">
                                <input class="form-control @error('ket_kelengkapan_spm') is-invalid @enderror"
                                    type="text" id="ket_kelengkapan_spm" name="ket_kelengkapan_spm" required>
                    ...
                    <div>
                        <div style="float: right;">
                            ...
                            <button id="update" class="btn btn-primary btn-md"><i class="fas fa-save mx-2"></i>Simpan
                                Draft</button>
                        </div>
                        <div>
...
@endsection
@section('js')
    @include('penatausahaan.pengeluaran.verifikasi_spp.js.create');
@endsection
