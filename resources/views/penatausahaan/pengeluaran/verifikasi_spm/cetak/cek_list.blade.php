...
<body>
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:14px" width="100%" align="center"
        ...
        <tr>
            <td style="text-align: center;font-size:16px;"><b>DATA ANTRIAN SPM</b></td>
        </tr>
    </table>
    <br>
        ...
        <tbody>
            ...
            @foreach ($detail as $data1)
                ...
                <tr>
                    ...
                    <td>{{ $data1->no_spm }}</td>
                    <td>{{ $data1->no_spp }}</td>
                    <td style="text-align: center;width: 30%">{{ $data1->kd_skpd }}</td>
                    <td style="width: 30%">{{ $data1->nm_skpd }}</td>
                    <td style="width: 50%">{{ beban($data1->jns_spp) }}</td>
                    <td style="width: 50%">{{ $data1->keperluan }}</td>
                    <td style="text-align: left;width: 15%">Rp.{{ rupiah($data1->nilai) }}</td>
                </tr>
            @endforeach
            <tr>
                <td colspan="7" style="font-size:12px;text-align:center"><b>J U M L A H </b></td>
