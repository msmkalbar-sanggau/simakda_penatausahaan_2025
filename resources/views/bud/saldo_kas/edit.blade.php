                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="nomor" name="nomor"
                                value="{{ $saldokas->nomor }}" required readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="rek_bank"
                                ...
                                <option value="3001006966" {{ $saldokas->rek_bank == '3001006966' ? 'selected' : '' }}>
                                    Bank-3001006966</option>
                                <option value="3001000016" {{ $saldokas->rek_bank == '3001000016' ? 'selected' : '' }}>
                                    Bank-3001000016</option>
                            </select>
                        </div>
