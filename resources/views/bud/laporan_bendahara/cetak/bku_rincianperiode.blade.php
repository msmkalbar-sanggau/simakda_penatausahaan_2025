...
<body>
    ...
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:14px" width="100%" align="center"
        ...
        <tr>
            <td style="text-align: center"><br> {{ tanggal($periode1) }} S/d
                {{ tanggal($periode2) }}<br></td>
        </tr>
        <tr>
            <td><br></td>
        </tr>
    ...
    <table style="width: 100%" border="1" id="rincian">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="6" class="angka">Jumlah Tanggal {{ tanggal($periode1) }} s.d Tanggal
                    {{ tanggal($periode2) }}</td>
            ...
            @endphp
            <tr>
                <td colspan="6" class="angka">Jumlah Sampai Dengan Tanggal {{ tanggal_sebelumnya($periode1) }}
                </td>
                <td class="angka">{{ rupiah($total_bku->trm_sbl + $saldo_awal->nil) }}</td>
                <td class="angka">{{ rupiah($total_bku->klr_sbl) }}</td>
            </tr>
            <tr>
                <td colspan="6" class="angka">Jumlah Sampai Dengan Tanggal {{ tanggal($periode2) }}</td>
    ...
    <table>
        <tr>
            <td>Pada hari ini, s.d tanggal {{ tanggal($periode2) }}</td>
        </tr>
        <tr>
