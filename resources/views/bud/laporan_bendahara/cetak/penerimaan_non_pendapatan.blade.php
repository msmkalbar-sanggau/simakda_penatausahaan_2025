...
<head>
    ...
    <title>PENERIMAAN NON PENDAPATAN</title>
    <style>
        table {
...
<body>
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:16px" width="100%" align="center"
        ...
        <tr>
            <td align="center" style="font-size:16px">
                <strong>
                    BUKU KAS PEMBANTU PENERIMAAN NON PENDAPATAN TAHUN ANGGARAN {{ tahun_anggaran() }}
                </strong>
            </td>
        </tr>
        <tr>
    ...
    @if (isset($tanda_tangan))
        <div style="padding-top:20px;padding-left:900px">
