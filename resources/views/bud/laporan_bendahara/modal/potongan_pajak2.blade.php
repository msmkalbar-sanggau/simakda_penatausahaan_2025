<div id="modal_potongan_pajak2" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row text-center">
                    ...
                    <div class="col-md-12">
                        <button type="button" class="btn btn-danger btn-md cetak_potongan_pajak2" data-jenis="pdf">
                            PDF</button>
                        <button type="button" class="btn btn-dark btn-md cetak_potongan_pajak2"
