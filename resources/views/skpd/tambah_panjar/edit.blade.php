                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="no_panjar_lalu"
                                ...
                                @foreach ($daftar_panjar as $panjar1)
                                    <option value="{{ $panjar1->no_panjar }}" data-nilai="{{ $panjar1->nilai }}"
                                        {{ $panjar1->no_panjar == $panjar->no_panjar_lalu ? 'selected' : '' }}>
                                        {{ $panjar1->no_panjar }} | {{ $panjar1->tgl_panjar }} |
                                        {{ rupiah($panjar1->nilai) }}
                                    </option>
                                @endforeach
                                </option>
                            </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="nilai" name="nilai" required
                                ...
                                value="{{ $panjar->nilai }}">
                            <input class="form-control" type="text" id="nilai_lalu" name="nilai_lalu" required
                                data-type="currency" style="text-align: right" value="{{ $panjar->nilai }}" readonly
                                hidden>
                        </div>
                    </div>
                    {{-- Total --}}
...
@endsection
@section('js')
    @include('skpd.tambah_panjar.js.edit');
@endsection
