        ...
        <tbody>
            ...
            @foreach ($data_rek as $rek)
                @if (strlen($rek->rek) == 2)
                    ...
                    @endphp
                    <tr>
                        <td style="vertical-align: top"><b>{{ dotrek($rek->rek) }}</b></td>
                        <td colspan="4"><b>{{ $rek->nama_rek }}</b></td>
                ...
                @else
                    <tr>
                        <td style="vertical-align: top">{{ dotrek($rek->rek) }}</td>
                        <td colspan="4">{{ $rek->nama_rek }}</td>
            ...
            @foreach ($data_giat as $giat)
                ...
                @endphp
                <tr>
                    <td style="vertical-align: top">{{ $giat->giat }}</td>
            ...
            <tr>
                ...
                <td class="angka"><b>{{ rupiah($total_ang) }}</b></td>
                <td colspan="3" style="text-align: center" class="angka"><b>{{ rupiah($total_jan + $total_feb + $total_mar) }}</b></td>
                <td colspan="3" style="text-align: center" class="angka"><b>{{ rupiah($total_apr + $total_mei + $total_jun) }}</b></td>
                <td colspan="3" style="text-align: center" class="angka"><b>{{ rupiah($total_jul + $total_ags + $total_sep) }}</b></td>
                <td colspan="3" style="text-align: center" class="angka"><b>{{ rupiah($total_okt + $total_nov + $total_des) }}</b></td>
            </tr>
            @if ($hidden != 'hidden')
                <tr>
                ...
                <tr>
                    <td colspan="14" class="ttd1"></td>
                    <td style="text-align: center" colspan="4" class="ttd2"><b><u>{{ $ttd1->nama }}</u></b>
                    </td>
                </tr>
                <tr>
                    <td colspan="14" class="ttd1"></td>
                    <td style="text-align: center" colspan="4" class="ttd2">NIP. {{ $ttd1->nip }}</td>
                </tr>
            @endif
        </tbody>
    </table>
