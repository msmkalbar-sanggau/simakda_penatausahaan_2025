    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    @csrf
                    <div class="alert alert-warning alert-block {{ $sp2d->status == 1 ? '' : 'hidden' }}">
                        <b style="font-size:16px">SP2D Sudah Cair!!</b>
                    </div>
                    {{-- No Cair --}}
                    <div class="mb-3 row">
                        <div class="col-md-12">
                            <a href="{{ route('skpd.pencairan_sp2d.index') }}" class="btn btn-warning btn-md">Kembali</a>
                            @if ($sp2d->status == '1')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            ...
                            {{-- {{ isset($sp2d->tgl_kas) ? $sp2d->tgl_kas : date('Y-m-d') }} --}}
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="no_kontrak" name="no_kontrak"
                                value="{{ cari_kontrak($sp2d->no_spp) }}" readonly>
                        </div>
                    </div>
...
@endsection
@section('js')
    @include('skpd.pencairan_sp2d.js.show');
@endsection
