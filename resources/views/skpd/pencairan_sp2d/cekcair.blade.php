...
<head>
    ...
    <title>CEK PENCAIRAN SP2D SKPD</title>
    <style>
        table {
...
<body>
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:14px" width="100%" align="center"
        ...
        <tr>
            <td style="text-align: center;font-size:16px;"><b>DATA SP2D YANG BELUM DICAIRKAN</b></td>
        </tr>
        <tr>
    ...
    <table style="width: 100%" border="1" id="rincian">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style= "text-align:left" class="angka"><b>Rp.{{ rupiah($total) }}</b></td>
            </tr>
        </tbody>
    </table>
</body>
