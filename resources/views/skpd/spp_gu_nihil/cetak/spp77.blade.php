...
<body>
    ...
    <table class="table table-bordered rincian" style="width: 100%;font-family:'Open Sans', Helvetica,Arial,sans-serif">
        <tr>
            <td colspan="4" style="text-align: center;border:1px solid black"><b>Ganti Uang Persediaan</b></td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: center;border:1px solid black"><b>SPP-GU</b></td>
        </tr>
