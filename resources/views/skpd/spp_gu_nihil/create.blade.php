...
@section('title', 'Input SPP GU NIHIL | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%;" id="beban"
                                name="beban">
                                <option value="7" selected>GU NIHIL</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-6 row" style="text-align;center">
                        <div class="col-md-12" style="text-align: center">
                            ...
                            <a href="{{ route('spp_gu_nihil.index') }}" class="btn btn-warning btn-md">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
@section('js')
    @include('skpd.spp_gu_nihil.js.create');
@endsection
