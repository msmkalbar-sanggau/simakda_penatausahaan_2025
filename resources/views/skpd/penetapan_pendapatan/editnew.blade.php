                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="no_tetap" name="no_tetap"
                                value={{ $tetap->no_tetap }} placeholder="Silahkan Diisi" required>
                            <input class="form-control" type="text" id="no_tetap_hidden" name="no_tetap_hidden"
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="date" id="tgl_tetap" name="tgl_tetap"
                                value={{ $tetap->tgl_tetap }} required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="kode_akun"
                                ...
                                @foreach ($daftar_akun as $akun)
                                    <option value="{{ $akun->kd_rek6 }}"
                                        {{ $akun->kd_rek6 == $tetap->kd_rek6 ? 'selected' : '' }}
                            ...
                            <input class="form-control" type="text" id="kode_rek_lo" name="kode_rek_lo"
                                value={{ $tetap->kd_rek_lo }} readonly hidden>
                        </div>
                        <label for="jns_pajak" class="col-md-2 col-form-label">Jenis
                            Pajak</label>
                        <div class="col-md-4">
                            <select id="jns_pajak_edit" name="jns_pajak_edit">
                                <option value=" ">-- Pilih -- </option>
                                @foreach ($ms_pajak as $pajak)
                                    <option value="{{ $pajak->kode_pajak }}"
                                        {{ $pajak->kode_pajak == $tetap->jenis ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="kd_sub_kegiatan" name="kd_sub_kegiatan"
                                value={{ $tetap->kd_sub_kegiatan }} required readonly>
                        </div>
                        <label for="nilai" class="col-md-2 col-form-label">Nilai</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="nilai" id="nilai"
                                pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency" value={{ $tetap->nilai }}
                    ...
                    <div class="mb-3 row" style="float: right;">
                        <div class="col-md-12" style="text-align: center">
                            <button id="simpan" class="btn btn-success btn-md">Update</button>
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#jns_pajak_edit").attr("disabled", true);
            $('#kode_akun').select2({
                ...
                if (kd_rek6 == '410106010001' || kd_rek6 == '410114370001') {
                    $("#jns_pajak_edit").attr("disabled", false);
                } else {
                    $('#jns_pajak_edit').text("");
                    // alert(hakam);
                    // $("#jns_pajak_edit").val(null);
                    $("#jns_pajak_edit").attr("disabled", true);

                    // $("#jns_pajak_edit").val("");
                }
                $("#jns_pajak_edit").focus();
            });
            $('#jns_pajak_edit').select2({
                placeholder: "Silahkan Pilih",
                theme: 'bootstrap-5'
            });
        ...
        $(document).ready(function() {
            $('#simpan').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('updatepenetapantahunini') }}",
                    type: 'POST',
                    data: {
                        data: data
                    },
