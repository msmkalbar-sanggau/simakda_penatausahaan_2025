...
@section('title', 'Input Ambil Simpanan Bank Ke Tunai | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <select name="bank" id="bank" style="width: 100%" class="form-control select2-multiple">
                                ...
                                @foreach ($daftar_bank as $bank)
                                    <option value="{{ $bank->kode }}" data-nama="{{ $bank->nama }}">{{ $bank->kode }}
                                        | {{ $bank->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" style="width: 100%" id="nm_rekening" name="nm_rekening"></textarea>
                        </div>
                    </div>
                    {{-- Keterangan --}}
                    <div class="mb-3 row">
