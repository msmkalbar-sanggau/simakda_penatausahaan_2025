...
@section('title', 'Input Setor Simpanan | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Sisa Kas Tunai dan Nilai --}}
                    <div class="mb-3 row">
                        <label for="sisa_kas" class="col-md-2 col-form-label">Sisa Kas Tunai</label>
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="sisa_kas" name="sisa_kas" required readonly
                                value="{{ rupiah($sisa_tunai) }}" style="text-align: right">
                        </div>
...
@endsection
@section('js')
    @include('skpd.setor_simpanan.js.create');
@endsection
