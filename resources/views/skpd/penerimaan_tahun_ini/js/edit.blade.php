<script>
    $(document).ready(function() {
        ...
        if (no_tetap != null && no_tetap != '') {
            document.getElementById('pilihan').checked = true;
            document.getElementById('pilihan').setAttribute("disabled", "disabled");
            $('#card_penetapan').show();
        } else {
            document.getElementById('pilihan').checked = false;
            document.getElementById('pilihan').setAttribute("disabled", "disabled");
            $('#card_penetapan').hide();
        }
        ...
        $('#kode_akun').on('select2:select', function() {
            ...
            if (kode_akun == '410106010001') {
                $('.pajak_hotel').show();
                // $('.pajak_mineral').hide();
            } else if (kode_akun == '410114370001') {
                $('.pajak_hotel').hide();
                // $('.pajak_mineral').show();
            } else {
                $('.pajak_hotel').hide();
        ...
        $('#no_tetap').on('select2:select', function() {
            ...
            let nilai = $(this).find(':selected').data('nilai_tetap');
