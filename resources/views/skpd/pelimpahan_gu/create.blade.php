            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="kd_skpd" name="kd_skpd">
                                ...
                                @foreach ($tujuan_skpd as $skpd)
                                    <option value="{{ $skpd->kd_skpd }}" data-nm_skpd="{{ $skpd->nm_skpd }}" data-skpd_sumber="{{ $skpd->skpd }}"
                                        data-skpd_ringkas="{{ $skpd->kd_ringkas }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="rekening_bendahara" name="rekening_bendahara">
                                <option value="" disabled selected>Silahkan Pilih</option>
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="rekening_tujuan" name="rekening_tujuan">
                                <option value="" disabled selected>Silahkan Pilih</option>
                                @foreach ($rekening_tujuan as $rekening)
                                    <option value="{{ $rekening->rekening }}" data-nm_rekening="{{ $rekening->nm_rekening }}" data-nm_bank="{{ $rekening->nm_bank }}">
                                        {{ $rekening->rekening }} |
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="nilai" id="nilai" readonly pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="currency"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="sisa_kas" name="sisa_kas" required readonly value="{{ rupiah($sisa_bank) }}"
                                style="text-align: right">
                        </div>
                    </div>
                    {{-- Keterangan --}}
...
@endsection
@section('js')
    @include('skpd.pelimpahan_gu.js.create');
@endsection
