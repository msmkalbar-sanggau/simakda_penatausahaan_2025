...
<body>
    ...
    <TABLE style="border-collapse:collapse;font-size:14px" border="1" cellspacing="' . $spasi . '"
        ...
        @foreach ($rincian as $data)
            ...
            <tr>
                <td style="border-bottom:hidden;border-right:hidden;" align="left"><b>&nbsp;{{ $no_bukti }}</b>
                </td>
        ...
        <TR>
            ...
            <TD align="right"><b>{{ rupiah($lalu->ls) }}</b></TD>
            <TD align="right"><b>{{ rupiah($lalu->up) }}</b></TD>
            <TD align="right"><b>{{ rupiah($lalu->gu) }}</b></TD>
            <TD align="right"><b>{{ rupiah($lalu->ls + $lalu->up + $lalu->gu) }}</b></TD>
        </TR>

        <TR>
            <TD colspan="2" align="left"><i><b>Jumlah s/d periode lalu </i></b></TD>
            <TD align="right"><b>{{ rupiah($sd_ini->ls) }}</b></TD>
            <TD align="right"><b>{{ rupiah($sd_ini->up) }}</b></TD>
            <TD align="right"><b>{{ rupiah($sd_ini->gu) }}</b></TD>
            <TD align="right"><b>{{ rupiah($sd_ini->ls + $lalu->up + $lalu->gu) }}</b></TD>
        </TR>
