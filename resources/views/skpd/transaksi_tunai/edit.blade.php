...
@section('title', 'Edit Transaksi Tunai | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="no_bukti" name="no_bukti"
                                value="{{ $transaksi->no_bukti }}" required readonly>
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="pembayaran"
                                name="pembayaran">
                                <option value="" disabled selected>Silahkan Pilih</option>
                                <option value="TUNAI" {{ $transaksi->pay == 'TUNAI' ? 'selected' : '' }}>TUNAI</option>
                            </select>
                        </div>
                    </div>
                    {{-- Keterangan --}}
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" style="width: 100%" id="keterangan" name="keterangan">{{ $transaksi->ket }}</textarea>
                        </div>
                    </div>
                    <!-- SIMPAN -->
                    ...
                    <table id="rincian_rekening" class="table" style="width: 100%">
                        ...
                        <tbody>
                            @php
                                $total_transaksi = 0;
                            @endphp
                            @foreach ($daftar_transaksi as $trans)
                                @php
                                    $total_transaksi += $trans->nilai;
                                @endphp
                                <tr>
                                    <td>{{ $trans->no_bukti }}</td>
                                    <td>{{ $trans->no_sp2d }}</td>
                                    <td>{{ $trans->kd_sub_kegiatan }}</td>
                                    <td>{{ $trans->nm_sub_kegiatan }}</td>
                                    <td>{{ $trans->kd_rek6 }}</td>
                                    <td>{{ $trans->nm_rek6 }}</td>
                                    <td>{{ rupiah($trans->nilai) }}</td>
                                    <td>{{ $trans->sumber }}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td>
                                        <a href="javascript:void(0);"
                                            onclick="deleteData('{{ $trans->no_bukti }}','{{ $trans->kd_sub_kegiatan }}','{{ $trans->kd_rek6 }}','{{ $trans->sumber }}','{{ $trans->nilai }}')"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: right"><input type="text"
                                        style="border:none;background-color:white;text-align:right;font-weight: bold;font-size:large;"
                                        class="form-control" readonly id="total"
                                        value="{{ rupiah($total_transaksi) }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="kd_sumber" readonly name="kd_sumber" hidden>
                        </div>
                    </div>
                    <!-- TOTAL SPD -->
                    <div class="mb-3 row" style="background-color: #87CEFA">
                    ...
                    <!-- ANGKAS -->
                    <div class="mb-3 row" style="background-color: #f83341">
                        <label for="total_angkas" class="col-md-2 col-form-label">Total
                            Anggaran Kas</label>
                        <div class="col-md-2">
                    ...
                    <!-- Anggaran -->
                    <div class="mb-3 row" style="background-color: #FFA07A">
                    ...
                    <!-- NILAI SUMBER DANA -->
                    <div class="mb-3 row" style="background-color: #FFD700">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered border-primary mb-0" style="width: 100%"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($daftar_transaksi as $trans)
                                        @php
                                            $total_input_rekening += $trans->nilai;
                                        @endphp
                                        <tr>
                                            <td>{{ $trans->no_bukti }}</td>
                                            <td>{{ $trans->no_sp2d }}</td>
...
@endsection
@section('js')
    @include('skpd.transaksi_tunai.js.edit');
@endsection
